...
% folders
%--------------------------------------------------------------------------
STUDYdir  = ['C:\Users\teresa\Documents\projects\ambiguous_voices\FMRI_study\data\MRI\1_nifti_prepared'];
FSdir     = ['C:\Users\teresa\Documents\projects\ambiguous_voices\FMRI_study\data\MRI\2_freesurfer'];
...
SPMdir    = ['C:\Users\teresa\Documents\software\spm12\spm12']; % path to your SPM12 folder
TPMdir    = [SPMdir,'/tpm'];
...
addpath(SPMdir)
addpath(['C:\Users\teresa\Documents\projects\ambiguous_voices\FMRI_study\scripts\Pre_Proc']) % path to your script folder
...
%     'av31a';...'
%     'av32a';...
%     'av33b';...%error in normalization
%     'av34b';... %normalization failed (could not read header of file)
%     'av37b';...
%     'av38b';...
    'av39b';...
    'av42a';...
...
for s = 1:size(subj,1)%change to "parfor" for parallel processing
    for r = 1
        cd(RUNdir{s,r})
...
matlabbatch{1}.spm.util.imcalc.output         = [T1dir,'/xcat.av.mean.t1.nii'];
...
copyfile('xcat.av.mean.t1.nii',...
    [FACTdir,'/xcat.av.mean.t1.nii']);
copyfile('xcat.av.mean.t1.nii',...
    [FACTdir,'/xcat.av.mean.t1.nii']);
